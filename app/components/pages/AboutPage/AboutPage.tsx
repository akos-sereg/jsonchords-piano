            ...
            <div className={styles.page}>
                <div className="panel panel-default">
                  <div className="panel-body">
                    <h1>Motivation</h1>
                    <p>
                        I started to learn playing the piano from YouTube, and Flowkey app. Reading piano sheets is too
                        complex for me, and I wanted to find a way to capture the songs that I have already learned: in
                        case I forgot some parts, I would have a chance to recap.
                    </p>
                    <p>
                        As a software developer, JSON format was a suitable option.
                    </p>
                  </div>
                </div>
                ...
                <div className="panel panel-default">
                  <div className="panel-body">
                    ...
                    <p>
                        GitHub: <a href="https://github.com/akos-sereg/jsonchords-piano" target='out'>https://github.com/akos-sereg/jsonchords-piano</a>
                    </p>
                  </div>
                </div>
